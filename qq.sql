...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='好友分组表' AUTO_INCREMENT=8 ;
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='消息表(群聊)' AUTO_INCREMENT=7 ;
...
CREATE TABLE IF NOT EXISTS `message_user` (
  ...
  KEY `to_user` (`to_user`),
  KEY `is_read` (`is_read`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='消息表(私聊)' AUTO_INCREMENT=50 ;
...
INSERT INTO `user` (`id`, `qq`, `pwd`, `phone`, `email`, `time`, `last_login`, `status`, `device`) VALUES
(1, '986992484', '53f6ff462b54af4141e76372436663', '18296764976', '986992484@qq.com', 1497695436, 1501170925, 1, 1),
(2, '986992483', '53f6ff462b54af4141e76372436663', '18296764975', '986992483@qq.com', 1499853636, 1501170914, 0, 0),
